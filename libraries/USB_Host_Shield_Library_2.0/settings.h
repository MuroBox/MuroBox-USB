...
// CHEN:20201019
// Pin definitions. Define it here because library cannot access
// header file outside the library directory in Arduino
#define ID_N_PIN 0x40 // Pin 6
#define INT_N_OUT3_PIN 0x20 // Pin 5
...
// CHEN:20201018
#define USB_HOST_SERIAL swSer//Serial
extern ESPSoftwareSerial swSer;
#endif
