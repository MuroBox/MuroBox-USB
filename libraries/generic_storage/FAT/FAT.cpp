...
// take out RTC clock for ESP8266
//#include <RTClib.h>
//Replace RTClib with ezTime for NTP integration and ESP8266 compatibility //
#include <ezTime.h>

//Timezone local;
extern Timezone temp_timezone;

uint32_t RTClock(){
        //return RTCnow().FatPacked(); //Replace RTClib with ezTime
        return temp_timezone.now(); //Replace RTClib with ezTime
}
...
void PFAT::Create(storage_t *sto, uint8_t lv, uint32_t first) {
        ...
        set_clock_call((void *)&RTClock); //Replace RTClib with ezTime
